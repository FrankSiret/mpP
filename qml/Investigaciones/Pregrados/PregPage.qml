...
Item {
    ...
    Row {
        ...
        Rectangle {
            ...
            FolderDialog {
                id: fileDialog
                title: "Cargar carpeta de Tesis de Pregrado"
    ...
    property string docsLocation: "file:///D:/DOCUMENTOS/FRANK/QT/mpP/res/Investigaciones/Pregrado";
}
