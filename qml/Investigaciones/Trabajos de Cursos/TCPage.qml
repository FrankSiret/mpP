...
Item {
    ...
    Row {
        ...
        Rectangle {
            ...
            FolderDialog {
                id: fileDialog
                title: "Cargar carpeta de Trabajos de Cursos"
    ...
    property string docsLocation: "file:///D:/DOCUMENTOS/FRANK/QT/mpP/res/Investigaciones/Trabajos de Curso";
}
